...
const checkMaintenance = async (req, res, next) => {
    try {
        ...
        if (doc.exists && doc.data().enabled === true) {
            ...
            if (req.path.startsWith('/api/admin/') || req.path === '/api/auth/verify') {
                return next();
            }
