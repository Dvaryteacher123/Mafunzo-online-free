...
async function testFirebaseConnection() {
    try {
        ...
        const publishedSnap = await db.collection('courses').where('status', '==', 'published').get();
        console.log(`📚 Published courses: ${publishedSnap.size}`);
        
        if (publishedSnap.size === 0) {
            console.log('⚠️ WARNING: No published courses found!');
            console.log('   Please add a course with status "published"');
        }
...
// ============================================
// COURSES ROUTES - WITH DEBUG LOGS
// ============================================
